 ...
 */
// Names use "." as the namespace separator, not ":" — BullMQ (as of v5)
// throws `Queue name cannot contain :` at construction time, since it
// reserves ":" for its own Redis key structuring (`bull:<queueName>:...`).
// Confirmed against the installed bullmq@5.81.3 source
// (classes/queue-base.js) after this convention crashed the worker on
// startup.
